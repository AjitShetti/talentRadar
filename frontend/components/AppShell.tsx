...
// No Career copilot entry: the copilot is the overview now — briefing, thread,
// memories and learning plan all live on that one page. The /agent route still
// exists for old links, but a nav item for it would advertise a second home
// for something that only has one.
const nav = [
