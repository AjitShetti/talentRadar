...
export default function LoginPage() {
  return <main className="auth-page"><section className="auth-aside"><Link className="brand" href="/"><span className="brand-mark">✳</span><span>Talent<span>Radar</span></span></Link><div><p className="eyebrow">CAREER INTELLIGENCE, MADE PERSONAL</p><h1>Make your next move with conviction<span>.</span></h1><p>One workspace for roles, applications, interview practice, and better resumes.</p></div><div className="auth-quote"><Sparkles size={18}/><span>Find the opportunities that fit—not merely the ones that appear first.</span></div></section><section className="auth-form-wrap"><Suspense fallback={<div className="loading-state">Preparing sign in…</div>}><LoginForm /></Suspense></section></main>
}
