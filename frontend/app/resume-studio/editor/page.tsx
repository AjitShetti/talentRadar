...
import {
  ArrowLeft, Check, ChevronDown, ChevronUp, Download, Eye, EyeOff, Plus, RefreshCw, Trash2,
} from 'lucide-react'
...
export default function ResumeEditorPage() {
  ...
  return (
    <RequireAuth>
      <AppShell>
        <Link href="/resume-studio" className="editor-back-link"><ArrowLeft size={13} /> Back to Resume Studio</Link>
        <section className="page-heading">
          <p className="eyebrow">RESUME STUDIO · LATEX EDITOR</p>
          <h1>Build your resume, section by section.</h1>
          <p>Edit structured sections on the left — your LaTeX source and compiled PDF stay in sync on the right, automatically.</p>
        </section>
